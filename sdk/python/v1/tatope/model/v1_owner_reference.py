...
class V1OwnerReference(ModelNormal):
    ...
    def __init__(self, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            api_version (str): API version of the referent.. defaults to ""  # noqa: E501
            kind (str): Kind of the referent. More info: https://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#types-kinds. defaults to ""  # noqa: E501
            name (str): Name of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names#names. defaults to ""  # noqa: E501
            uid (str): UID of the referent. More info: https://kubernetes.io/docs/concepts/overview/working-with-objects/names#uids. defaults to ""  # noqa: E501
