...
def lazy_import():
    ...
    globals()['V1PartialObjectMetadata'] = V1PartialObjectMetadata


class V1PartialObjectMetadataList(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'items': ([V1PartialObjectMetadata],),  # noqa: E501
    ...
    def __init__(self, items, *args, **kwargs):  # noqa: E501
        """V1PartialObjectMetadataList - a model defined in OpenAPI

        Args:
            items ([V1PartialObjectMetadata]): items contains each of the included items.
