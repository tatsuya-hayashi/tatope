...
class V1Condition(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, last_transition_time, *args, **kwargs):  # noqa: E501
        ...
        Keyword Args:
            message (str): message is a human readable message indicating details about the transition. This may be an empty string.. defaults to ""  # noqa: E501
            reason (str): reason contains a programmatic identifier indicating the reason for the condition's last transition. Producers of specific condition types may define expected values and meanings for this field, and whether the values are considered a guaranteed API. The value should be a CamelCase string. This field may not be empty.. defaults to ""  # noqa: E501
            status (str): status of the condition, one of True, False, Unknown.. defaults to ""  # noqa: E501
            type (str): type of condition in CamelCase or in foo.example.com/CamelCase.. defaults to ""  # noqa: E501
