...
def lazy_import():
    ...
    globals()['V1TableColumnDefinition'] = V1TableColumnDefinition
    globals()['V1TableRow'] = V1TableRow


class V1Table(ModelNormal):
    ...
    def openapi_types():
        ...
        lazy_import()
        return {
            'column_definitions': ([V1TableColumnDefinition],),  # noqa: E501
            'rows': ([V1TableRow],),  # noqa: E501
    ...
    attribute_map = {
        'column_definitions': 'columnDefinitions',  # noqa: E501
        'rows': 'rows',  # noqa: E501
    ...
    @convert_js_args_to_python_args
    def __init__(self, column_definitions, rows, *args, **kwargs):  # noqa: E501
        """V1Table - a model defined in OpenAPI

        Args:
            column_definitions ([V1TableColumnDefinition]): columnDefinitions describes each column in the returned items array. The number of cells per row will always match the number of column definitions.
            rows ([V1TableRow]): rows is the list of items in the table.
