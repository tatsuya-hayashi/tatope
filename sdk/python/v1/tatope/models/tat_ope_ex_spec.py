...
class TatOpeExSpec(BaseModel):
    """
    TatOpeExSpec defines the desired state of TatOpeEx
    """ # noqa: E501
    bar: Optional[StrictStr] = None
    foo: Optional[StrictStr] = Field(default=None, description="Foo is an example field of TatOpeEx. Edit tatopeex_types.go to remove/update")
