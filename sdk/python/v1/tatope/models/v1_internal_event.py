...
class V1InternalEvent(BaseModel):
    """
    InternalEvent makes watch.Event versioned
    """ # noqa: E501
    object: K8sIoApimachineryPkgRuntimeObject = Field(alias="Object")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Object": K8sIoApimachineryPkgRuntimeObject.from_dict(obj["Object"]) if obj.get("Object") is not None else None,
