...
class V1PartialObjectMetadataList(BaseModel):
    """
    ...
    items: List[V1PartialObjectMetadata] = Field(description="items contains each of the included items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "items": [V1PartialObjectMetadata.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "kind": obj.get("kind"),
