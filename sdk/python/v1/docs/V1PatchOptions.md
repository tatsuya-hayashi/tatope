...
json = "{}"
# create an instance of V1PatchOptions from a JSON string
v1_patch_options_instance = V1PatchOptions.from_json(json)
# print the JSON string representation of the object
print(V1PatchOptions.to_json())

# convert the object into a dict
v1_patch_options_dict = v1_patch_options_instance.to_dict()
# create an instance of V1PatchOptions from a dict
v1_patch_options_from_dict = V1PatchOptions.from_dict(v1_patch_options_dict)
```
