...
**message** | **str** | message is a human readable message indicating details about the transition. This may be an empty string. | defaults to ""
**reason** | **str** | reason contains a programmatic identifier indicating the reason for the condition&#39;s last transition. Producers of specific condition types may define expected values and meanings for this field, and whether the values are considered a guaranteed API. The value should be a CamelCase string. This field may not be empty. | defaults to ""
**status** | **str** | status of the condition, one of True, False, Unknown. | defaults to ""
**type** | **str** | type of condition in CamelCase or in foo.example.com/CamelCase. | defaults to ""
