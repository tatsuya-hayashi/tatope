...
class TestV1PartialObjectMetadata(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> V1PartialObjectMetadata:
        """Test V1PartialObjectMetadata
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `V1PartialObjectMetadata`
        """
        model = V1PartialObjectMetadata()
        if include_optional:
